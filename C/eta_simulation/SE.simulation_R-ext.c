 ...
 *========================================================*/
    ...
    while ((evol_steps < total_evol_steps) || (evol_time_2 < max_time)) {
        ...
        //* recalculating eta and finding the difference. However, I never experienced this issue, so 
...
void MCMC_Sequence(struct seq_struct *seq){
    ...
    ////////////////////////////////////////
		...
		accept_pr = fmin(tSeq.mu_obs/seq->mu_obs*exp(-Q*(2*Ne-1)*seq->phi_obs*(tSeq.eta_obs-seq->eta_obs)),1);
